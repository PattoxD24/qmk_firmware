...
#define _____________________NUMPAD_3_______________________ KC_P0, KC_P1, KC_P2, KC_P3, KC_DOT, KC_BSLASH
...
#define _____________MOD_RIGHT____________ LT_LOW, KC_BSPC, KC_LALT, T_CPAP
