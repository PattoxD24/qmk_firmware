# QMK User Configuration for [pattoxd](https://github.com/pattoxd/qmk-yonas)
...
## [pattoxd.c](pattoxd.c)
- pattoxd [QMK user configuration](https://github.com/qmk/qmk_firmware/blob/master/docs/feature_userspace.md)
- On `keymap.c` include `pattoxd.h`
  ```c
  #include "pattoxd.h"
  ```

## Supported Keyboards
- [Crkbd ](../../keyboards/crkbd/keymaps/pattoxd)
- [Hotdox](../../keyboards/hotdox/keymaps/pattoxd)
- [Pinky3](../../keyboards/pinky/3/keymaps/pattoxd)
- [Lily58](../../keyboards/lily58/keymaps/pattoxd)
- [Kyria](../../keyboards/kyria/keymaps/pattoxd)
...
|M_MALL | Macro to send QMK make command to all [pattoxd](#Supported%20Keyboards) keyboards |
